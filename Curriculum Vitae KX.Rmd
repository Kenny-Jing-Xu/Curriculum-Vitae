...
Aguilera, A., Figueroa, C.A., Hernandez-Ramos, R., Sarkar, U., Cemballi, A.G., Gomez-Pathak, L., Miramontes, J., Avila-Garcia, P., Tov, E.Y., Chakraborty, B., Yan, X., **Xu, J.**, Modiri, A., Aggarwal, J., Williams, J.J., Lyles, C.R. (2020). An mHealth app using machine learning to increase physical activity in diabetes and depression: clinical trial protocol for the DIAMANTE Study. BMJ Open. **Accepted**
